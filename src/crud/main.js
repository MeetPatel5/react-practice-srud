      ...
      <Fragment>
        ...
        <Modal basic size="small" open={this.state.open}>
          ...
          <Modal.Content>
            <h3>First Name</h3>
            <Input
              error={first_name.length <= 0 ? true : false}
              value={first_name}
              onChange={this.handleFirstNameChange}
            />
            <h3>Last Name</h3>
            <Input
              error={last_name.length <= 0 ? true : false}
              value={last_name}
          ...
          <Modal.Actions>
            ...
            <Button
              disabled={
                first_name.length <= 0 || last_name.length <= 0 ? true : false
              }
              color="green"
              inverted
        ...
        <Grid>
          <Grid.Row>
            {this.props.employees
              ...
              .map(emp => (
                <Grid.Column key={emp.id} mobile={16} tablet={8} computer={4}>
                    ...
                    <Card.Content>
                      ...
                      <div>
                        <Icon
                          ...
                          size="big"
                          color="red"
                          onClick={() => this.handleDeleteEmployee(emp.id)}
                        />
                        <Icon
                          name="edit"
                          size="big"
                          color="green"
                          onClick={() => this.handleEditEmployee(emp.id)}
                        />
                      </div>
                    </Card.Content>
                  </Card>
